...
class TrainPipeline:
    ...
    """
    Purpose: 
    1. Manage the data validation process.
    2. Initializes the DataValidationConfig using the training pipeline configuration.
    3. Creates an instance of the DataValidation class, passing the data_ingestion_artifact and the validation configuration.
    4. Calls the initiate_data_validation method to perform validation on the ingested data.
    5. Returns the resulting DataValidationArtifact, which contains metadata about the validation process.
    6. Similar to the previous method, any exceptions are caught and raised as SensorException.
    """
